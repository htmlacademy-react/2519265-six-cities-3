...
export const isOfferForCard = (offer: OfferType): offer is OfferForCardType => 'previewImage' in offer;

export const isOfferForOffer = (offer: OfferType): offer is OfferFullType => 'description' in offer;
